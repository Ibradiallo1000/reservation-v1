  ...
  return (
    ...
    >
      ...
      <div className="max-w-lg mx-auto p-4 print:p-0 print:max-w-none">
        ...
        <div 
          ref={receiptRef}
          className="receipt-container bg-white rounded-xl shadow-sm overflow-hidden print-border-top"
        >
          {/* En-tête du reçu */}
          <div 
          ...
          <div className="p-3 print:p-2 print-py-1">
            ...
            <div className="flex justify-between items-start mb-3 pb-1 border-b border-gray-200 compact-section">
              ...
              <div className="text-right">
                <span
                  className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium print-text-sm"
                  style={{
            ...
            <div className="mb-3 compact-section">
              <h3 className="text-sm font-semibold mb-1" style={{ color: primaryColor }}>
                Client
              </h3>
        ...
        {/* Boutons d'action */}
        <div className="no-print mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
          <button
            onClick={handlePDF}
