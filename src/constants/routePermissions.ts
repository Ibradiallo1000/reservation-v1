...
export const routePermissions = {
  ...
  boarding: ["chefEmbarquement", "chefAgence", "escale_agent", "admin_compagnie"] as const,
  ...
  guichet: ["guichetier", "chefAgence", "escale_agent", "admin_compagnie"] as const,
  escaleDashboard: ["escale_agent", "chefAgence", "admin_compagnie"] as const,
  ...
  cashControl: ["guichetier", "agentCourrier", "agency_accountant", "chefAgence", "admin_compagnie"] as const,
} as const;
