...
export default function TreasuryNewOperationPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionCard title="Nouvelle operation de tresorerie" icon={PlusCircle}>
        ...
        <SectionCard title="Soumettre une depense">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Compte de depense</label>
                <select
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                  value={accountId}
      ...
      {!loading && operation === "transfer" && (
        <SectionCard title="Transferts">
          <p className="text-sm text-gray-600 mb-3">
            Cette operation reutilise les services de tresorerie existants: transfert interne, depot agence vers banque, mobile money vers banque.
          </p>
      ...
      {!loading && operation === "supplier_payment" && (
        <SectionCard title="Paiements fournisseurs">
          <p className="text-sm text-gray-600 mb-3">
            Cette operation reutilise le domaine existant payables / paymentProposals / payPayable.
          </p>
